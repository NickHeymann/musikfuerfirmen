...
const team: TeamMember[] = [
  {
    ...
    bioText: "Hi, ich bin Jonas. Ich bin euer direkter Kontakt vor Ort. Mit 7 Jahren habe ich angefangen Gitarre zu spielen und stehe seitdem auf der Bühne. Ich koordiniere die Band und alles rund um Technik. Vor Musikfürfirmen.de habe ich selbst in vielen Coverbands gespielt und als Techniker Bands wie Revolverheld und Adel Tawil auf Tour begleitet.",
    imageClass: "img1",
  },
  {
    name: "Nick Heymann",
    ...
    <section className="team-section">
      <div className="team-row">
        ...
        <div className="bio-card">
          <span className="bio-tag">{team[0].bioTitle}</span>
          <p className="bio-text">{team[0].bioText}</p>
        ...
        <div className="person-card">
          ...
          <div className="title">
            {team[1].role}<br />
            {team[1].roleSecondLine}
          </div>
        </div>

        {/* Bio Card Nick - Rechts */}
        <div className="bio-card">
          <span className="bio-tag">{team[1].bioTitle}</span>
          <p className="bio-text">{team[1].bioText}</p>
          <a href={`${basePath}/ueber-uns`} className="mehr-link">
            Mehr erfahren <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12h14"/><path d="M12 5l7 7-7 7"/></svg>
          </a>
        </div>
